            ...
            <?php if (!empty($requests)): ?>
                ...
                <tr>
                    ...
                    <td class="text-center" style="white-space: nowrap;">
                        ...
                        <a href="/Document-Entry-System/public/uploads/<?= htmlspecialchars($request['filename']) ?>" class="btn btn-outline-primary btn-sm ms-2" target="_blank">Изтегли</a>
                ...
                <tr>
                    ...
                    <td class="text-center" style="white-space: nowrap;">
                        <?php if (!empty($step['uploaded_file'])): ?>
                            <a href="/Document-Entry-System/public/uploads/<?= htmlspecialchars($step['uploaded_file']) ?>"
